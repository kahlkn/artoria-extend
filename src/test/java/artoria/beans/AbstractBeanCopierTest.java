...
abstract class AbstractBeanCopierTest {
    ...
    void doCopyMapToObject(BeanCopier beanCopier) {
        Dog newDog = RandomUtils.nextObject(Dog.class);
    ...
    void doCopyObjectToMap(BeanCopier beanCopier) {
        Dog fromDog = RandomUtils.nextObject(Dog.class);
    ...
    void doCopyObjToObjToTestTypeConvert(BeanCopier beanCopier) {
        SimplePersonDTO fromPerson = RandomUtils.nextObject(SimplePersonDTO.class);
    ...
    void doCopyObjToOtherObjToTestPropertyList(BeanCopier beanCopier) {
        OrdinaryPerson fromPerson = RandomUtils.nextObject(OrdinaryPerson.class);
        List<Skill> skillList = new ArrayList<Skill>();
        for (int i = ZERO; i < ONE; i++) {
            skillList.add(RandomUtils.nextObject(Skill.class));
        }
