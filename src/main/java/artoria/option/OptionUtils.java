...
public class OptionUtils {
    ...
    public static String getStringOption(String owner, String name, String defaultValue) {
    ...
    public static boolean getBooleanOption(String owner, String name, boolean defaultValue) {
    ...
    public static int getIntegerOption(String owner, String name, int defaultValue) {
